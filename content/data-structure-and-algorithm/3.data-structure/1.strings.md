...
We can achieve a better time and space complexity by using a **two-pointer approach** that swaps characters in-place, without the need to create a new string or array.
