...
- **Substitution method:** 
This involves solving the recurrence relation by guessing a closed-form solution and then proving it using mathematical induction.
...
These methods can be used alone or in combination, depending on the specific recurrence relation and the desired solution.
